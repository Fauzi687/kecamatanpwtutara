...
var format_Grendeng_3 = new ol.format.GeoJSON();
var features_Grendeng_3 = format_Grendeng_3.readFeatures(json_Grendeng_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Grendeng_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Grendeng_3.addFeatures(features_Grendeng_3);
var lyr_Grendeng_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Grendeng_3,
maxResolution:14.00223307613098,
 minResolution:0.28004466152261964,

                style: style_Grendeng_3,
                popuplayertitle: 'Grendeng',
                interactive: true,
                title: '<img src="styles/legend/Grendeng_3.png" /> Grendeng'
            });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_GoogleMaps_1.setVisible(true);lyr_GoogleTerrainHybrid_2.setVisible(true);lyr_Grendeng_3.setVisible(true);lyr_Kuburan_4.setVisible(true);lyr_Kesehatan_5.setVisible(true);lyr_Sekolah_6.setVisible(true);lyr_BalaiDesa_7.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_GoogleMaps_1,lyr_GoogleTerrainHybrid_2,lyr_Grendeng_3,lyr_Kuburan_4,lyr_Kesehatan_5,lyr_Sekolah_6,lyr_BalaiDesa_7];
lyr_Grendeng_3.set('fieldAliases', {'GID_4': 'GID_4', 'GID_0': 'GID_0', 'COUNTRY': 'COUNTRY', 'GID_1': 'GID_1', 'NAME_1': 'NAME_1', 'GID_2': 'GID_2', 'NAME_2': 'NAME_2', 'GID_3': 'GID_3', 'NAME_3': 'NAME_3', 'NAME_4': 'NAME_4', 'VARNAME_4': 'VARNAME_4', 'TYPE_4': 'TYPE_4', 'ENGTYPE_4': 'ENGTYPE_4', 'CC_4': 'CC_4', });
...
lyr_Grendeng_3.set('fieldImages', {'GID_4': 'TextEdit', 'GID_0': 'TextEdit', 'COUNTRY': 'TextEdit', 'GID_1': 'TextEdit', 'NAME_1': 'TextEdit', 'GID_2': 'TextEdit', 'NAME_2': 'TextEdit', 'GID_3': 'TextEdit', 'NAME_3': 'TextEdit', 'NAME_4': 'TextEdit', 'VARNAME_4': 'TextEdit', 'TYPE_4': 'TextEdit', 'ENGTYPE_4': 'TextEdit', 'CC_4': 'TextEdit', });
...
lyr_Grendeng_3.set('fieldLabels', {'GID_4': 'no label', 'GID_0': 'no label', 'COUNTRY': 'no label', 'GID_1': 'no label', 'NAME_1': 'no label', 'GID_2': 'no label', 'NAME_2': 'no label', 'GID_3': 'no label', 'NAME_3': 'no label', 'NAME_4': 'inline label - always visible', 'VARNAME_4': 'no label', 'TYPE_4': 'no label', 'ENGTYPE_4': 'no label', 'CC_4': 'no label', });
